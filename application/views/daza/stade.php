      ...
      <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="staticBackdropLabel">Ajouter un stade</h5>
                  <button type="button" class="close false" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  <form autocomplete="off" action="<?= site_url('daza/stade_controller/stade') ?>" method="post">
                      <div class="form-group">
                          <label for="exampleInputEmail1">Stade</label>
                          <input type="text" class="form-control" aria-describedby="emailHelp" name="stade" value="<?= set_value('stade') ?>">
                          <?= form_error('stade') ?>
                        </div>
                      <div class="form-group">
                          <label for="exampleInputEmail1">Localisation</label>
                          <input type="text" class="form-control" aria-describedby="emailHelp" name="lieu" value="<?= set_value('lieu') ?>">
                          <?= form_error('lieu') ?>
                        </div>
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <p class="card card-body vide"> GESTIONS DES STADES
...
<?= form_error('new_lieu') ?>
  ...
  <table id="example1" class="table table-bordered table-hover">
        ...
        <tr>
          ...
          <td><label><?php echo $rows['nom_stade']; ?></label></td>
          <td><label><?php echo $rows['lieu_stade']; ?></label></td>
          <td>
              <button class="collapsible orange" data-toggle="tooltip" title="modifier"><i class="fa fa-pen"></i></button>
              <div class="content">
                <form action="<?= site_url('daza/Stade_controller/update_stade?id=').$rows['id_stade']  ?>" method="post">
                    <div class="form-group row">
                      <label for="staticEmail" class="col-sm-2 col-form-label">Stade</label>
                      <div class="col-sm-4">
                        <input type="text" class="form-control" aria-describedby="emailHelp" name="new_stade" value="<?= $rows['nom_stade'] ?>"><?= form_error('new_stade') ?>
                      </div>
                    </div>
                     <div class="form-group row">
                      <label for="staticEmail" class="col-sm-2 col-form-label">Lieu
                      </label>
                      <div class="col-sm-4">
                        <input type="text" class="form-control" aria-describedby="emailHelp" name="new_lieu" value="<?= $rows['lieu_stade'] ?>"><?= form_error('new_lieu') ?>
                      </div>
          ...
          <td>
            <div class="icon-bar">
               <button onclick="supp(<?php echo $rows['id_stade']; ?>)" data-toggle="tooltip" title="supprimer" class="orange"><i class="fa fa-trash" >
              </i></button>
            </div>        
          </td>
        </tr>
...
<script>
 ...
 function supp(id){
    ...
    Swal.fire({
            title: 'Voulez-vous vraiment supprimer ce stade ?',
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url : "<?php echo site_url('daza/Stade_controller/delete_stade')?>",
                        type: "POST",
                      data: {id:id},
                        success: function(data)
                        {
                            ...
                            location.reload();
                            Swal.fire('<label class="erreur"> suppressions effectuées avec succes</label>');
                        },
