...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <ul class="card card-body vide"> GESTIONS DES ANNEES ACADEMIQUES</ul>
    <?php echo $data_annee ?>
    <?= form_error('new_annee') ?>
    <?= form_error('annee_entrant') ?>  
    <div class="card-body">
  <table id="example1" class="table table-bordered table-hover">
      <thead>
        ...
        <tr>
          <td>
            <label><?php echo $annee['id_anneee'] ?></label>
          </td>
          <td><label><?php echo $annee['annee'] ?></label></td>
          <td class="mod">
            <label>
              <?php
                if ($annee['etat_annee']==1) 
                {
               ?>
             </label>
              <button class="orange" data-toggle="tooltip" title="modification impossible" disabled=""><i class="fa fa-pen"></i></button>
                <?php
                  }else{
                 ?>
              <button class="collapsible orange" data-toggle="tooltip" title="modifier"><i class="fa fa-pen"></i></button>
              <div class="content">
                <form action="<?= site_url('daza/Annee_controller/update_annee?id=').$annee['id_anneee']  ?>" method="post">
                    <div class="form-group row">
                      <label for="staticEmail" class="col-sm-2 col-form-label">Annee</label>
                      <div class="col-sm-4">
                        <input type="text" class="form-control" aria-describedby="emailHelp" name="new_annee" value="<?= $annee['annee'] ?>" required maxlength="9">
                      </div>
          ...
          <td class="mode">
             <?php
                ...
                {
               ?>
              <label class="red" data-toggle="tooltip" title="année cloturé">Cloturé...</label>
                <?php
                  }else{
                 ?>
              <button class="collapsible entre" data-toggle="tooltip" title="veillez saisir l'année academique entrant">Cloturé</button>
              <div class="content">
                <form action="<?= site_url('daza/Annee_controller/insert_annee?id=').$annee['id_anneee']  ?>" method="post">
                    <div class="form-group row">
                      <label for="staticEmail" class="col-sm-2 col-form-label">Annee</label>
                      <div class="col-sm-4">
                        <input type="text" class="form-control" aria-describedby="emailHelp" name="annee_entrant" placeholder="annee entrant" required maxlength="9">
                      </div>
                      <button type="submit" class="btn btn-success btne">
                         ok
                       </button>
