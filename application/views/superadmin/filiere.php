      ...
      <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
              <div class="modal-header">
                  <h5 class="modal-title" id="staticBackdropLabel">Ajouter une Filiere</h5>
                ...
                <div class="modal-body">
                   <form action="<?php echo site_url('superadmin/Formulaire_controller/filiere') ?>" method="post">
                      ...
                      <?= form_error('filiere1') ?>
                        ...
                        <span class="collapsible float-right" data-toggle="tooltip" title="ajouter une autre filiere"></span>
...
<!-- Content Wrapper. Contains page content -->
  ...
  <table id="example1" class="table table-bordered table-hover">
        ...
        <?php $filiere=$this->db->query('select * from filiere');
            $i=1;
        ...
        <tr>
          ...
          <td><label><?php echo $filiere->nom_filiere ?></label></td>
             <td>
              <button class="collapsible orange" data-toggle="tooltip" title="modifier"><i class="fa fa-pen"></i></button>
              <div class="content">
                <form action="<?= site_url('superadmin/Affiche_controller/update_filiere?id=').$filiere->id_filiere  ?>" method="post">
                    <div class="form-group row">
                      <label for="staticEmail" class="col-sm-2 col-form-label">Filiere</label>
                      <div class="col-sm-4">
                        <input type="text" class="form-control" aria-describedby="emailHelp" required="" name="new_filiere" value="<?= $filiere->nom_filiere ?>"><?= form_error('new_filiere') ?>
                      </div>
