  ...
  <div class="row">
          ...
          <div class="col-lg-6 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h4><b>COMPTES</b></h4>
                <p><b>Pour faciliter l'attribution du "nom utilisateur", il serait preferable de mettre: "RC19gin1" ("RC" pour responsable de classe "19" pour la promotion "gin1" le nom de la salle).<br> "RCIUT" ("RC" pour responsable de compétition "IUT" pour l'etablissement).</b></p>
              </div>
              <div class="icon">
                <i class="fa fa-fw fa-wrench"></i>
              </div>
              <a href="<?php echo site_url('superadmin/compte_controller/update_compte') ?>" class="small-box-footer">Commencer <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-6 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h4><b>PARCOURS</b></h4>
                <p><b>Vous pouvez ajouter, modifier et supprimer un parcours. Avant<br>
                   d'ajouter un parcours, il est obligatoire d'enregistrer les <br> informations relatives au parcours c'est a dire l'etablissement,<br> le cycle et la filiere.</b></p>
              </div>
              <div class="icon">
                <i class="fa fa-fw fa-wrench"></i>
              </div>
              <a href="<?php echo site_url('superadmin/parcours_controller/recuparcours') ?>" class="small-box-footer">Commencer <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-6 col-6">
            ...
            <div class="small-box bg-secondary">
              <div class="inner">
                <h4><b>ETABLISSEMENT</b></h4>
                <p><b>Consulter la liste des differents etablissements enregistrés, ajouter,<br> modifier et rechercher les informations relatives à un etablissement.</b></p>
              </div>
              <div class="icon">
                <i class="nav-icon fas fa-plus-circle"></i>
              </div>
              <a href="<?php echo site_url('superadmin/Affiche_controller/etablissement') ?>" class="small-box-footer">Commencer <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <!-- ./col -->
          <div class="col-lg-6 col-6">
            ...
            <div class="small-box bg-light">
              <div class="inner">
                <h4><b>CYCLES</b></h4>
                <p><b>Consulter la liste des differents cycles enregistrés, ajouter,<br> modifier et rechercher les informations relatives à un cycle.</b></p>
              </div>
              <div class="icon">
                <i class="nav-icon fas fa-plus-circle"></i>
              </div>
              <a href="<?php echo site_url('superadmin/Affiche_controller/cycle') ?>" class="small-box-footer">Commencer <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
