                ...
                <div class="modal-body">
                   <form action="<?php echo site_url('superadmin/Formulaire_controller/cycle') ?>" method="post">
                      ...
                      <?= form_error('cycle1') ?>
                        ...
                        <span class="collapsible float-right" data-toggle="tooltip" title="ajouter un autre cycle"></span>
...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <p class="card card-body vide"> GESTIONS DES CYCLES
  ...
  <table id="example1" class="table table-bordered table-hover">
        ...
        <?php $cycle=$this->db->query('select * from cycle');
        $i=1;
        ...
        <tr>
          ...
          <td><label><?php echo $cycle->nom_cycle ?></label></td>
             <td class="mod">
              <button class="collapsible orange" data-toggle="tooltip" title="modifier"><i class="fa fa-pen"></i></button>
              <div class="content">
                <form action="<?= site_url('superadmin/Affiche_controller/update_cycle?id=').$cycle->id_cycle  ?>" method="post">
                    <div class="form-group row">
                      <label for="staticEmail" class="col-sm-2 col-form-label">Cyle</label>
                      <div class="col-sm-4">
                        <input type="text" class="form-control" aria-describedby="emailHelp" name="new_cycle" value="<?= $cycle->nom_cycle ?>"required><?= form_error('new_cycle') ?>
                      </div>
