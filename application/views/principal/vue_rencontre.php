							...
							<div class="single-post row">
								...
								<div class="col-lg-9 col-md-9 ">
                                    ...
                                    <?php echo $rencontre['nom']; ?> <?php echo $rencontre['sigle']; ?> &ensp;&ensp; <small> <?php echo $rencontre['type_competition']; ?> &ensp; de &ensp; <?php echo $rencontre['nom_discipline']; ?></small> </h3></a>
                                        <b> <?php echo $rencontre['nom_equipe1']; ?> </b> &ensp; &ensp; &ensp;  <small> Contre </small> &ensp; &ensp; &ensp; <b> <?php echo $rencontre['nom_equipe2']; ?></b>  
                                        <p class="posts-title" href="blog-single.html">
									<p class="excert">
                                       <b style="color: black;" >  Phase : </b>  <b> <?php echo $rencontre['nom_phase']; ?></b> <br> 
                                         Date rencontre :
                                          <?php
