    ...
    background-size: cover;">
				...
				<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							<h1 class="text-white">
								Details sur la publication			
							</h1>	
							<p class="text-white link-nav"><a href="#">Accueil </a>  <span class="lnr lnr-arrow-right"></span>Publications</p>
						</div>	
				</div>
			</section>
			<!-- End banner Area -->
						...
						<div class="col-lg-10 posts-list">
							<div class="single-post row">
								...
								<div class="col-lg-9 col-md-9 ">
                                 ...
                                 <small> Daté du :  <?php   $date = new DateTime($pub['post']);
						  echo $date->format("d-M-Y-H:i"); ?> </small>  
									</p>
