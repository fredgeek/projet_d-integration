    ...
    background-size: cover;">
				...
				<div class="row d-flex align-items-center justify-content-center">
						<div class="about-content col-lg-12">
							...
							<p class="text-white link-nav"><a href="index.html">Accueil </a>  <span class="lnr lnr-arrow-right"></span>Blog des Athlètes</p>
						</div>	
				</div>
			</section>
			<!-- End banner Area -->
						...
						<div class="col-lg-10 posts-list">
							<div class="single-post row">
								...
								<div class="col-lg-9 col-md-9 ">
									...
									<a class="posts-title" href="blog-single.html"><h3>Aucune information disponible</h3></a>
									<p class="excert">
									Les informations concernants les athlètes ne sont pas disponibles pour le moment
									</p>
