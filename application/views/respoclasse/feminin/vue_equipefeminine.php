 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3>Joueuses  de votre equipe </h3> 
          </div>
          <div class="col-sm-6">
          <a href="<?php echo site_url();?>/respoclasse/discipline_feminine"> <button class="btn  btn-outline-success"><i class="fas fa-undo"></i> Retour</button> </a>
   &ensp; &ensp;  &ensp;  &ensp;  &ensp;  <a href="<?php echo site_url();?>/respoclasse/add_player">  <button class="btn  btn-outline-danger"><i class="fas fa-edit"></i>Modifier</button></a>
    ...
    <?php $i=0;  foreach($joueur as $row): $i++; ?>
