...
<div class="content-header">
 ...
 <!-- Main content -->
 <section class="content">
    <a href="<?php echo site_url('/respoclasse/joueurs_f');?>/id/<?php echo $info['equipe_id']; ?>/discipline/<?php echo $info['discipline']; ?>"> <button class="btn  btn-outline-success"><i class="fas fa-user-plus"></i></button> </a>
