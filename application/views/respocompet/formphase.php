...
<a href="<?php echo site_url("/respocompet/create_groupes");?>/compet/<?php echo  $this->session->userdata('id_compet');?>/discipline/<?php echo $this->session->userdata('id_discipline');?>"><button type="button" class="btn btn-outline-info">Enregistrer</button></a> 
<br>
<br>
<div class="card">
<div class="card-body">
                ...
                <form action="#" id="form" data-backdrop="static" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input name="date_debut" min="<?php echo $debut ;?>" max="<?php echo $fin ;?>" class="form-control" type="date">
                        ...
                        <input name="discipline_id"  class="form-control" value="<?php echo $this->session->userdata('id_discipline');?>" type="hidden">
